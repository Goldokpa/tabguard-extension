...
const summarizationStatus = new Map();
// --- Helper Functions ---
/**
 ...
 */
async function shouldSummarizeTab(tabId, url, content) {
 ...
 */
async function generateTabSummary(tabId, url, title, content) {
    try {
        // Mark as processing
...
async function handleTabUpdate(tabId, changeInfo, tab) {
    if (!tab.url || !tab.title || changeInfo.status !== 'complete')
        return;
